...
INSERT INTO `t_admin` VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', '管理员', NULL,  NULL, '2020-01-01 00:00:00', '2020-01-01 00:00:00');
...
INSERT INTO `t_role` VALUES (1, '2014-07-02 00:02:44', '2014-07-02 00:02:44', '拥有管理后台最高权限', b'1', '超级管理员');
...
INSERT INTO `zhifu_admin`.`t_role_authority`(`role_id`, `authorities`) VALUES (1, 'admin:admin');
INSERT INTO `zhifu_admin`.`t_role_authority`(`role_id`, `authorities`) VALUES (1, 'admin:role');
INSERT INTO `zhifu_admin`.`t_role_authority`(`role_id`, `authorities`) VALUES (1, 'admin:menu');
INSERT INTO `zhifu_admin`.`t_role_authority`(`role_id`, `authorities`) VALUES (1, 'admin:storage_plugin');
...
INSERT INTO `zhifu_admin`.`t_plugin_config`(`id`, `create_date`, `modify_date`, `orders`, `is_enabled`, `plugin_id`) VALUES (1, '2020-03-08 23:23:29', '2020-03-08 23:23:29', NULL, 0, 'filePlugin');
